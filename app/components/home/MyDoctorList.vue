    ...
    <StackLayout>
        <DockLayout class="container-list">
            ...
            <StackLayout dock="left" orientation="vertical" style="padding:15px;" horizontalAlignment="stretch">
                ...
                <Label :text="item.doctor_id" visibility="collapse" textWrap="true" /> 
                <Label :text="item.clinic_name" textWrap="true" class="text-primary" style="font-size:12pt;color:#828282;margin-top:2px" />
            </StackLayout>
            <Image
            dock="right"
